...
|`featureName`|||0,1|&#160;&#160;&#160;&#160;language|||0,1| (S) `name`|OBJNAM/NOBJNM||0,1| (S) `nameUsage`|||0,1|`fixedDateRange`|||0,1| (S) `dateEnd`|DATEND/PEREND/SUREND||0,1| (S) `dateStart`|DATSTA/PERSTA/SURSTA||0,1|`height`|HEIGHT||0,1
