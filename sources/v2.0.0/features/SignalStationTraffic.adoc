.Signal Station Traffic의 정의
[cols="3,2,1,1", options="header"]
|===
4+h|*Definition:* A traffic signal station is a place on shore from which signals are made to regulate the movement of traffic.
4+h|*Primitives:* point, surface
h|Attribute h|Acronym h|Type h|Mult.

|span:E[category of signal station, traffic]|CATSIT|EN|1,*
