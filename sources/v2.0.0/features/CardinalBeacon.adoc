...
|===
4+h|*Definition:* A cardinal beacon is used in conjunction with the compass to indicate where the mariner may find the best navigable water. It is placed in one of the four quadrants (North, East, South and West), bounded by inter-cardinal bearings from the point marked.
4+h|*Primitives:* point
h|Attribute h|Acronym h|Type h|Mult.

|span:E[beacon shape]|BCNSHP|EN|1,1
|span:E[category of cardinal mark]|CATCAM|EN|1,1
