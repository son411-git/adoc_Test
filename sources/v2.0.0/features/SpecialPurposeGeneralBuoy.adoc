.Special Purpose/General Buoy의 정의
[cols="3,2,1,1", options="header"]
|===
4+h|*Definition:* A special purpose buoy is primarily used to indicate an area or feature, the nature of which is apparent from reference to a chart, Sailing Directions or Notices to Mariners.
