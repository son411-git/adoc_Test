.Isolated Danger Buoy의 정의
[cols="3,2,1,1", options="header"]
|===
4+h|*Definition:* An isolated danger buoy is a buoy moored on or above an isolated danger of limited extent, which has navigable water all around it.
