...
|===
4+h|*Definition:* A lateral beacon is used to indicate the port or starboard hand side of the route to be followed. They are generally used for well defined channels and are used in conjunction with a conventional direction of buoyage.
4+h|*Primitives:* point
h|Attribute h|Acronym h|Type h|Mult.

|span:E[beacon shape]|BCNSHP|EN|1,1
|span:E[category of lateral mark]|CATLAM|EN|1,1
