.Traffic Separation Scheme Aggregation의 정의
[%header, cols="a,a,a,a"]
|===
...
//
* span:F[Traffic Separation Scheme]와 구성요소 간 span:R[Traffic Separation Scheme Aggregation] 관계 설정
  **Collection**:: span:F[Traffic Separation Scheme][S] span:D[1개]
  **Component**:: span:F[Traffic Separation Scheme Boundary] span:D[2개], span:F[Traffic Separation Scheme Lane Part] span:D[2개], span:F[Separation Zone or Line] span:D[1개]
...
* span:F[Traffic Separation Scheme]와 구성요소 간 span:R[Traffic Separation Scheme Aggregation] 관계 설정
  **Collection**:: span:F[Traffic Separation Scheme][S] span:D[1개]
  **Component**:: span:F[Traffic Separation Scheme Boundary] span:D[2개], span:F[Traffic Separation Scheme Lane Part] span:D[4개], span:F[Separation Zone or Line] span:D[1개]

//
* 통항구간의 방위각이 바뀌기 때문에 span:F[Traffic Separation Scheme Lane Part]를 구분하여 입력 +
  span:F[Traffic Separation Scheme Boundary]나 span:F[Separation Zone or Line]는 구분하지 않음
...
* span:F[Traffic Separation Scheme]와 구성요소 간 span:R[Traffic Separation Scheme Aggregation] 관계 설정
  **Collection**:: span:F[Traffic Separation Scheme][S] span:D[1개]
  **Component**:: span:F[Traffic Separation Scheme Boundary] span:D[2개], span:F[Traffic Separation Scheme Lane Part] span:D[3개], span:F[Separation Zone or Line] span:D[1개]

//
* 그림에서 span:F[Traffic Separation Scheme Lane Part](3) 'Junction Area' 에 해당하는 객체는 span:A[orientation value] 값을 입력하지 않아야 함
...
* span:F[Traffic Separation Scheme]와 구성요소 간 span:R[Traffic Separation Scheme Aggregation] 관계 설정
  **Collection**:: span:F[Traffic Separation Scheme][S] span:D[1개]
  **Component**:: span:F[Traffic Separation Scheme Boundary] span:D[4개], span:F[Traffic Separation Scheme Lane Part] span:D[8개], span:F[Traffic Separation Scheme Crossing] span:D[1개], span:F[Separation Zone or Line] span:D[4개]
...
* span:F[Traffic Separation Scheme]와 구성요소 간 span:R[Traffic Separation Scheme Aggregation] 관계 설정
  **Collection**:: span:F[Traffic Separation Scheme][S] span:D[1개]
  **Component**:: span:F[Traffic Separation Scheme Boundary] span:D[3개], span:F[Traffic Separation Scheme Lane Part] span:D[5개], span:F[Separation Zone or Line] span:D[2개], span:F[Precautionary Area] span:D[1개]
...
PrecautionaryArea: # Surface Type
  ...
  vesselSpeedLimit:
    ...
    speedUnit: 4 # (Knots)
  information:
    headline: Precautionary Area
    language: eng
    text: This area may be congested or ships may cross navigate, so mariners are advised to navigate with caution.
  information:
    headline: 주의구역
    language: kor
    text: 이 구역은 선박이 밀집되거나 교차 항해의 우려가 있으므로 주의하여 항행하여야 함.
----
====
