...
|===
| image:../images/MagneticVariation/MagneticVariation_D.png[]
| image:../images/MagneticVariation/MagneticVariation_D_SV.png[]
| WMM Main Field Declination Map +
(Epoch 2025)
| WMM Annual change Declination Map +
(Epoch 2025)
|===
