...
** 동일한 채널을 사용하는 span:F[Radio Calling In Point]가 여러 개 있는 경우, span:F[Contact Details]에 속성 span:A[communication channel]에 채널을 입력하고, span:F[Radio Calling In Point]와 span:F[Contact Details] 간 연관관계를 설정
