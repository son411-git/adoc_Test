...
* 케이블카 입력 시 span:A[Category of conveyor] = 1 span:d[aerial cableway]로 입력
* 가항수역에서 span:F[Conveyor]의 지지대는 span:F[Pylon/Bridge Support]로 span:A[Category of pylon] = 3 span:d[aerial cableway pylon]를 입력
...
|category of conveyor|CATCON|EN|0,1| 1 span:d[aerial cableway]
|**feature name**||C|0,*|
