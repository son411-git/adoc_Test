...
===== Remark
* 통항분리제도가 적용되는 수역 중 항로가 교차하는 구역을 의미
** 회전 교차 구역을 나타내는 span:F[Traffic Separation Scheme Roundabout]과는 구분해서 사용해야 함
...
//
:ObjectName: span:F[Traffic Separation Scheme Crossing]을
:Relation: span:R[Traffic Separation Scheme Aggregation]
:linkTo: TSS_AGGR
include::common/phrase.adoc[tag=Refer]

//
* 횡단 구역에 관한 항행 제한사항이 있다면, span:A[restriction]을 이용하여 입력 할 수 있음
