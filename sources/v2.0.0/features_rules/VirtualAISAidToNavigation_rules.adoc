...
--
.등대표의 V-AIS
image::../images/VirtualAISAidToNavigation/Virtual_AtoN.png[]
.입력 예시 (KR4F2O10)
image::../images/VirtualAISAidToNavigation/Virtual_Example.png[]
--
...
image::../images/VirtualAISAidToNavigation/Synthetic_AtoN.png[]
.예시 (KR5G1N34)
