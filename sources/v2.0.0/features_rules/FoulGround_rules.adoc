...
//
* span:F[Foul Ground]가 span:A[status] = ( 9 : value reported (not confirmed) ) 일 때 span:A[reported date]은 필수
...
| span:F[Obstruction] +
span:A[category of obstruction] = ( 6 : foul area ) +
span:A[quality of vertical measurement] = ( 6 : least depth known ) +
span:A[value of sounding] = ( 10 ) +
span:A[water level effect] = ( 3 : always under water/submerged ) +
