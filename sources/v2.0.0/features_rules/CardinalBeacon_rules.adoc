...
** 등화는 백색등으로 Q 또는 VQ 등광을 가지나, 북쪽은 연속 점멸, 동쪽은 3회 점멸, +
...
** 입표(Beacon)에 span:F[Fog Signal], span:F[Radar Transponder Beacon] 및 등화 등 장비 역할의 객체들이 있다면 span:R[Structure/Equipment] 관계 설정
