...
|4 : leading light 
| B-475.6
| image:../Appendix/Lights_General_CATLIT_04.png[] 
| 다른 등화와 연결되어 도등 및 지도선을 형성하는 등화
|5 : aero light 
| B-476.1
| image:../Appendix/Lights_General_CATLIT_05.png[] 
| 항공 항법을 위해 설치된 등화, 해상등보다 출력이 높고 해안에서 훨씬 멀리서도 볼 수 있음
|8 : flood light 
| B-478.2
| image:../Appendix/Lights_General_CATLIT_08.png[] 
| 투광등, 구조물이나 구역을 비추는데 사용되는 광폭 등화
|9 : strip light 
| B-478.5
| image:../Appendix/Lights_General_CATLIT_09.png[] 
| 선형등, 광원이 일반적으로 수평인 선형 형태를 가지며, 길이가 수 미터에 달할 수 있는 등화
|10 : subsidiary light 
| B-471.8
| image:../Appendix/Lights_General_CATLIT_10.png[]
...
| B-471.8
| image:../Appendix/Lights_General_CATLIT_19.png[] 
| 수평으로 배치된 동일한 등질과 위치의 등화군
|20 : vertically disposed 
| B-471.8
| image:../Appendix/Lights_General_CATLIT_20.png[] 
